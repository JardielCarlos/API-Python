...
filmes = [
    ...
    {'nome': 'Velozes e Furiosos', 'descricao': 'Filme de acao com corrida ',
        'id': "1"},  # Sem caracteres especiais para não bugar o browser
...
def post():
    ...
    filmes.insert(
        tamanho + 1, {"id": f'{body["id"]}', "nome": f'{body["nome"]}', 'descricao': f'{body["descricao"]}'})
